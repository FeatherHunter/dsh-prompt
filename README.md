...
# 锁定最新版更稳（当前 0.1.9）：
dsh plugin --profile web add dsh-prompt@0.1.9 --registry https://registry.npmjs.org
#     或者
dsh plugin --profile desktop add dsh-prompt@0.1.9 --registry https://registry.npmjs.org
```
